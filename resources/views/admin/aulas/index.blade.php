                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row d-flex justify-content-center">
                                            ...
                                            <form action="{{ url('/admin/aulas/' . $aula->id) }}"
                                                method="POST"
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ url('/admin/aulas/create') }}"
                        method="POST">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number"
                                            class="form-control"
                                            name="capacidad_create"
                                            value="{{ old('capacidad_create', 60) }}"
                                            min="1"
                                            required>
